...
function Navbar() {
  ...
  const [navBg, setNavBg] = useState("#f6eee8");
  const [linkColor, setLinkColor] = useState("#f6eee8")
  ...
  return (
    ...
    >
      <div className="flex justify-between items-center w-full h-full px-2 2xl:px-16 ">
        <Link href="/">
          <Image
            src="/../public/assets/FemPure_logo.png"
            alt="/"
            height="85"
            width="100"
      ...
      >
        <div
          className={
            nav
              ? "fixed left-0 top-0 w-[75%] sm:w-[60%] md:w-[45%] h-screen bg-[#f6eee8] p-10 ease-in duration-500 "
